    ...
    <div class="row">
        <div class="col-sm-3 col-md-2">
            ...
            <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="#home"><span class="badge pull-right">42</span>New Orders</a>
                </li>
                <li><a href="#profile">Pending Orders</a></li>
                <li><a href="#messages">Deliverd Orders</a></li>
